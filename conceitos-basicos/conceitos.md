## Tópico 3 – Conceitos Básicos de Teste de Software
...
Quando um software não é testado e apresenta muitos problemas, isso pode gerar grandes prejuízos de **tempo**, **dinheiro** e também afetar negativamente a **reputação da empresa**.  
...
Ele não envolve execução do sistema, não possui entrada nem saída de dados.  
